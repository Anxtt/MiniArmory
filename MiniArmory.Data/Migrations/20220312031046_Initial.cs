        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialisationDescription = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    SpecialisationImage = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Win = table.Column<short>(type: "smallint", nullable: false),
                    Loss = table.Column<short>(type: "smallint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    IsRacial = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AchievementCharacter", x => new { x.AchievementsId, x.CharactersId });
                    table.ForeignKey(
                        name: "FK_AchievementCharacter_Achievements_AchievementsId",
                        column: x => x.AchievementsId,
                        principalTable: "Achievements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AchievementCharacter_Characters_CharactersId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    CharactersId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MountsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AchievementCharacter_CharactersId",
                table: "AchievementCharacter",
                column: "CharactersId");
